...
const Footer = () => {
  return (
    <footer className="bg-foreground text-background py-12 xs:py-14 sm:py-16 relative overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 xs:gap-10 sm:gap-12">
            <div className="sm:col-span-2">
              <div className="text-2xl xs:text-3xl font-bold gradient-text-animated mb-4 xs:mb-6">
                Puspal Das
              </div>
            ...
            <div>
              ...
              <ul className="space-y-2 xs:space-y-3">
                <li><a href="#home" className="text-background/70 hover:text-background transition-colors text-sm xs:text-base animated-underline">Home</a></li>
                <li><a href="#about" className="text-background/70 hover:text-background transition-colors text-sm xs:text-base animated-underline">About</a></li>
                <li><a href="#skills" className="text-background/70 hover:text-background transition-colors text-sm xs:text-base animated-underline">Skills</a></li>
                <li><a href="#portfolio" className="text-background/70 hover:text-background transition-colors text-sm xs:text-base animated-underline">Portfolio</a></li>
                <li><a href="#contact" className="text-background/70 hover:text-background transition-colors text-sm xs:text-base animated-underline">Contact</a></li>
              </ul>
            </div>
          ...
          <div className="border-t border-background/20 mt-12 xs:mt-14 sm:mt-16 pt-6 xs:pt-8 text-center">
            <p className="text-background/70 text-sm xs:text-base flex items-center justify-center gap-1">
              © {new Date().getFullYear()} Puspal Das. Crafted with <Heart className="w-4 h-4 text-red-400 fill-red-400 animate-pulse inline" /> & code.
            </p>
          </div>
        </div>
      </div>
